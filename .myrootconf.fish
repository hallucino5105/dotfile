...
set -x PATH $HOME/dotfile/udf $PATH
set -x LESS "-cgisSFMRX"
set -x PAGER "less -cgisSFMRX"
set -x GIT_PAGER "less -cgisSFMRX"
set -x MANPAGER "less -cgisSFMRX"
set -x EDITOR "vim -p"
set -x LOGZERO_FORCE_COLOR "1"
